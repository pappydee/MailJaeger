...
class SensitiveDataFilter(logging.Filter):
    ...
    SENSITIVE_PATTERNS = [
        ...
        (
            re.compile(r'(user["\s:=]+)([^\s,}\]]+@[^\s,}\]]+)', re.IGNORECASE),
            r"\1[REDACTED]",
        ),
        ...
        (
            re.compile(r'(key["\s:=]+)[A-Za-z0-9_\-]{20,}', re.IGNORECASE),
            r"\1[REDACTED]",
        ),
        ...
        (
            re.compile(r'(body_plain["\s:=]+)[\s\S]{200,}', re.IGNORECASE),
            r"\1[EMAIL_BODY_REDACTED]",
        ),
        (
            re.compile(r'(body_html["\s:=]+)[\s\S]{200,}', re.IGNORECASE),
            r"\1[EMAIL_BODY_REDACTED]",
        ),
        (
            re.compile(r'(content["\s:=]+)[\s\S]{200,}', re.IGNORECASE),
            r"\1[CONTENT_REDACTED]",
        ),
    ]
