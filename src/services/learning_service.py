    ...
    def _update_folder_pattern(self, email_id: int, target_folder: str):
        ...
        try:
            ...
            email = (
                ...
                .filter(ProcessedEmail.id == email_id)
                .first()
            )
        ...
        try:
            ...
            patterns = (
                ...
                .filter(
                    FolderPattern.sender_pattern == sender_pattern,
                    FolderPattern.category == email.category,
                    FolderPattern.confidence
                    >= self.settings.learning_confidence_threshold,
                )
                .order_by(FolderPattern.confidence.desc())
                .all()
            )
