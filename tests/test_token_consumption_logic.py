...
class TestBatchApplyTokenLogic:
    ...
    def test_batch_apply_flow(self):
        ...
        assert token.is_used == True, "Token should be consumed after successful batch apply"
...
class TestSingleActionApplyTokenLogic:
    ...
    def test_single_action_apply_flow(self):
        ...
        assert token.is_used == True, "Token should be consumed after successful single action apply"
