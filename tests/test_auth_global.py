...
class TestGlobalAuthMiddleware:
    ...
    def test_root_returns_401_without_auth(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert response.json() == {"detail": "Unauthorized"}, "Should return minimal error"
            assert "WWW-Authenticate" in response.headers, "Should include WWW-Authenticate header"
            assert response.headers["WWW-Authenticate"] == "Bearer", "Should be Bearer auth"
    ...
    def test_root_returns_200_with_valid_auth(self):
        ...
        with patch.dict(os.environ, {
            ...
            response = client.get("/", headers={"Authorization": "Bearer test_key_12345"})
    ...
    def test_docs_returns_401_without_auth(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert response.status_code == 401, "/api/docs should return 401 without auth"
            assert response.json() == {"detail": "Unauthorized"}, "Should return minimal error"
    ...
    def test_redoc_returns_401_without_auth(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert response.status_code == 401, "/api/redoc should return 401 without auth"
            assert response.json() == {"detail": "Unauthorized"}, "Should return minimal error"
    ...
    def test_openapi_returns_401_without_auth(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert response.status_code == 401, "/openapi.json should return 401 without auth"
            assert response.json() == {"detail": "Unauthorized"}, "Should return minimal error"
    ...
    def test_api_endpoint_returns_401_without_auth(self):
        ...
        with patch.dict(os.environ, {
            ...
            assert response.status_code == 401, "/api/settings should return 401 without auth"
            assert response.json() == {"detail": "Unauthorized"}, "Should return minimal error"
    ...
    def test_no_api_key_configured_returns_401(self):
        ...
        with patch.dict(os.environ, {
            ...
            response = client.get("/api/docs")
            assert response.status_code == 401, "Docs should return 401 when no API key configured"
